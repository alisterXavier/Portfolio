      ...
      <div className="selected-wrapper">
        <figure className="selected-figure mx-auto border">
          {projectSelected.img.length > 0 ? 
            ...
            modules={[Mousewheel, Autoplay, EffectFade, Navigation, Pagination]}
            className="mySwiper"
          >
        ...
        <div className="selected-project my-5" layoutId={projectSelected.title}>
          ...
          <div className="flex justify-between">
            ...
            <a
              className={`text-lime-400 hover:underline ${!projectSelected.app_link && "hidden"}`}
